...
1. Clone or download the `imessage-review` repository.
...
If the user hasn't installed the helper yet, **direct them to the installation guide** at `hosts/grok-bot/README.md` in this repository, or walk them through it step-by-step. Do not proceed with iMessage actions until the helper is installed and FDA is granted.
...
> "To read your iMessages, I need to know where you installed the iMessage helper. What folder did you run `install.sh` in? (For example: `~/imessage-bridge` or `~/Documents/cowork-imessage`)"
...
- **Installation guide for Grok Bot users:** `hosts/grok-bot/README.md`
...
This skill is part of the `imessage-review` project, licensed under MIT.
